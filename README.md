...
- **Las tablas se alinean bajo demanda**, no solas: Ctrl+Alt+T reformatea el
  fuente para que las columnas cuadren. No se hace al abrir porque reescribir el
  documento del usuario sin pedirlo no es aceptable.
